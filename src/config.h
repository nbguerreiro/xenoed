...
static const XenoedCommand XENOED_COMMANDS[] = {
    { "example-none", "your-script-here", 't', CMD_INPUT_NONE },
    { "example-buffer", "your-script-here", 'b', CMD_INPUT_BUFFER },
    { "example-selection", "your-script-here", 's', CMD_INPUT_SELECTION },
